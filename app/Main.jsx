      ...
      <div className="flex-grow flex items-center justify-center flex-col gap-6">
        ...
        <div className="flex gap-2">
          <Input
            ...
            className="border-2 border-black px-6 rounded-md w-48 h-12 sm:w-64"
          />
          ...
          <Button
            className="py-6 px-10 bg-white text-black border-2 border-black hover:bg-gray-100 font-bold py-6 px-6 text-sm rounded-full"
            onClick={handleReset}
          >
            <RotateCcw />
          </Button>
