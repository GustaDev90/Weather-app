        ...
        <section>
          {session ? (
            ...
            <Button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-[#24292e] hover:bg-[#2f363d] rounded-md transition-colors duration-300"
            >
